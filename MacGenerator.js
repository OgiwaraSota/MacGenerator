...
const menu = [
    ...
    //ドリンク
    { name: "コカ・コーラ", price: 120, attribute: 3 },
    { name: "コカ・コーラゼロ", price: 120, attribute: 3 },
    { name: "スプライト", price: 120, attribute: 3 },
    { name: "ファンタグレープ", price: 120, attribute: 3 },
    { name: "ファンタメロン", price: 120, attribute: 3 },
    { name: "Qoo 白ぶどう", price: 120, attribute: 3 },
    { name: "爽健美茶", price: 120, attribute: 3 },
    { name: "アイスティー(ストレート)", price: 120, attribute: 3 },
    { name: "アイスティー(レモン)", price: 120, attribute: 3 },
    { name: "アイスティー(ミルク)", price: 120, attribute: 3 },
    { name: "ホットティー(ストレート)", price: 120, attribute: 3 },
    { name: "ホットティー(レモン)", price: 120, attribute: 3 },
    { name: "ホットティー(ミルク)", price: 120, attribute: 3 },
    { name: "アイスティー(ミルク)", price: 120, attribute: 3 },
    { name: "野菜生活", price: 170, attribute: 3 },
